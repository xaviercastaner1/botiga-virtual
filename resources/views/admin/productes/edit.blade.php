...
<div class="container">
    ...
    <form action="{{route('producte.update', ['id' => $producte->id])}}" method="POST">
    @csrf
        <div class="row">
            <div class="d-flex flex-column gap-3 col-8">
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" name="descripcio" class="form-control">{{$producte->descripcio}}
                    </textarea>
                </div>
                ...
                <div class="d-flex gap-5">
                    ...
                    <div class="form-group w-100">
                        ...
                        @foreach($categories as $categoria)
                            ...
                            {{ $categoria == $producte->categoria ? 'selected' : '' }}>
                                {{ucwords($categoria)}}
                            </option>
                        @endforeach
                        </select>
            ...
            <div class="d-flex flex-column justify-content-center col">
                <img src="{{$producte->imatge}}" width="300">
            </div>
        </div>
